...
import { postRecordStart } from "../../redux/recordSlice";
import VisitedMem from "./VisitedMem";

function Ziyara() {
  const { records, isFetching, refetch } = useGetRecord();
  const { isPosting } = useSelector((state) => state.records);
